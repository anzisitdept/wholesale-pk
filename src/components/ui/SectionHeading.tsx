  ...
  return (
    <div className={`w-full flex items-center justify-center gap-4 sm:gap-6 lg:gap-8 ${className}`}>
      ...
      <div className="flex flex-col items-center text-center flex-shrink-0 max-w-[85vw] sm:max-w-none">
        <h2 className="font-display font-black text-[26px] xs:text-[30px] sm:text-[34px] md:text-[38px] lg:text-[40px] leading-tight text-white uppercase tracking-tight [text-shadow:0_0_20px_rgba(255,255,255,0.2)]">
          {title}
        </h2>
        ...
        {viewAllLink ? (
          <Link
            href={viewAllLink}
            className="mt-2 md:mt-2.5 inline-flex items-center gap-1.5 text-xs sm:text-[13px] md:text-sm font-bold uppercase tracking-wider text-[#007aff] hover:text-[#3b9eff] transition-colors group"
          >
